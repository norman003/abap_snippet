...
**        AND versn EQ '000'.
**
**    LOOP AT ltcovp ASSIGNING FIELD-SYMBOL(<fs>).
**      IF <fs>-aufnr IS NOT INITIAL. lsaufnr-low = <fs>-aufnr. COLLECT lsaufnr INTO lr-aufnr. ENDIF.
**    ENDLOOP.
...
<<<<<<< HEAD:__report/i_report_c01.abap
  METHOD report_denomination_set.
  ENDMETHOD.
=======
>>>>>>> bc5e8a90cd892da5d68e80132fdd3ab2364bfea4:_include/i_report_c01.txt
